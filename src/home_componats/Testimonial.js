...
const Testimonial = () => {
  ...
  return (
   <section className='testimonial bg-[#0D0E0F] text-center'>
        <div className="container_custom 2xl:w-[1440px] xl:!max-w-full mx-auto xl:p-[120px] lg:px-[80px] lg:py-[120px] py-[60px] xsm:px-[40px] px-[20px]">
            <div className="con">
                ...
                <div className="content mt-20">
                    <div className="testimonial_container">
                        <div className="part_1 flex justify-between gap-[24px] gap-y-10 flex-wrap">
                            <div className="main_box xl:w-[31%] lg:w-[414px] w-full">
